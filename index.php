...
<section class="container-fluid" style="padding-bottom: 200px;">
	<div class="container">
		...
		<!-- similar row 1 -->
				<div class="row pt-5">
					<div class="col-md-2 d-flex justify-content-center align-items-center">
						<img src="assets/icons/members.png" height="50px">
					</div>
					...
					<div class="col-md-10">
						...
						<p>
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum labore, sint nihil!
						</p>
					</div>
				</div>
		...
		<!-- similar row 2 -->
				<div class="row pt-3">
					<div class="col-md-2 d-flex justify-content-center align-items-center">
						<img src="assets/icons/sun.png" height="50px">
					</div>
		...
		<!-- similar  row 3 -->
				<div class="row pt-3">
					<div class="col-md-2 d-flex justify-content-center align-items-center">
						<img src="assets/icons/graph.png" height="50px">
					</div>
